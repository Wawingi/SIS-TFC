    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div style="background-color:#3bafda;color:white" class="modal-header">
                <h4 style="color:white" class="modal-title" id="myCenterModalLabel"><i class='fa fa-pencil-alt'></i> Actualizar Área de Aplicação</h4>
            ...
            <div class="modal-body">
                <form id="formularioEditar" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="nome_edit" name="nome_edit" placeholder="ex: Inovação Tecnológica">
                    </div> 
                    <input required type="hidden" class="form-control" id="id_edit" name="id_edit" placeholder="ex: Inovação Tecnológica">    
                    <hr>
