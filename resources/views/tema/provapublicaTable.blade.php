@foreach($provapublica as $pp)
    <tr>
        <td colspan="6"><span style="text-align:center;font-weight:bold"><i class="fas fa-tasks mr-1"></i>DADOS DA PROVA PÚBLICA</span><a href="#" id_prova="{{$pp->id}}" class="eliminarProvaPublica float-right btn btn-danger btn-sm btn-rounded"><i class='fa fa-trash-alt mr-2'></i>Eliminar</a></td>
    </tr>
    <tr>
