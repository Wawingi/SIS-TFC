...
@section('content')
<div style="margin-top:-70px" class="cabecalho">
    <img style="margin-left:-550px;margin-top:50px" height="120" src="data:image/jpg;base64,{{$estudante->logotipoUAN}}">
    ...
    <p id="dpto">ACTA DA SESSÃO DE DEFESA DO TRABALHO DE FIM DE CURSO</p>
    <p id="titulo">ACTA Nº._____ / {{$anoActual}}</p>
</div>

<div style="margin-left:45px;margin-right:15px;font-size:16px;text-align:justify">
    ...
    <p style="line-height:1.5">
       O Júri declarou aberta a sessão pública às______ e a sessão foi conduzida nos termos do
       regulamento de Trabalho de Fim de Curso, tendo sido encerrada às _______.<br>
       Concluída a sessão e prévia atribuição da nota, a avaliação é a seguinte:<br>
       - Avaliação da Defesa do Trabalho de Fim de Curso ____________ Valores.<br>
       - Avaliação Final ________________________________ Valores
    </p>
    <p>
        Observações:<br>
