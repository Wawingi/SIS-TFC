...
INSERT INTO `area_aplicacao` (`id`, `nome`, `visibilidade`, `id_departamento`, `created_at`, `updated_at`, `deleted_at`) VALUES
	...
	(33, 'Gestão de Dados', 1, 10, '2022-07-05 13:45:32', '2022-07-05 13:45:32', NULL);
...
-- Dumping data for table sis_tfc.envolvente: ~2 rows (approximately)
...
INSERT INTO `estudante` (`id_pessoa`, `numero_mecanografico`, `periodo`, `id_curso`, `created_at`, `updated_at`) VALUES
	...
	(113, '1990', 'Diurno', 7, '2022-07-05 11:21:32', '2022-07-05 11:21:32');
...
-- Dumping data for table sis_tfc.estudante_sugestao: ~2 rows (approximately)
...
-- Dumping data for table sis_tfc.item: ~2 rows (approximately)
/*!40000 ALTER TABLE `item` DISABLE KEYS */;
INSERT INTO `item` (`id`, `titulo`, `anexo`, `id_trabalho`, `avaliacao`, `comentario`, `created_at`, `updated_at`) VALUES
	(9, 1, 'KULONGA - GESTãO DE TFC\'S_4_PRETEXTUAL.pdf', 4, 1, 'Este item teve aprovação.', '2022-07-22 12:56:06', '2022-07-22 12:58:38'),
	(10, 2, 'KULONGA - GESTãO DE TFC\'S_4_TEXTUAL.pdf', 4, 1, 'Este item teve aprovação.', '2022-07-22 12:56:44', '2022-07-22 12:58:45'),
	(11, 3, 'KULONGA - GESTãO DE TFC\'S_4_POSTEXTUAL.pdf', 4, 1, 'Este item teve aprovação.', '2022-07-22 12:57:31', '2022-07-22 12:58:58');
...
-- Dumping data for table sis_tfc.nota_informativa: ~1 rows (approximately)
...
INSERT INTO `nota_informativa` (`id`, `local`, `presidente`, `secretario`, `vogal_1`, `vogal_2`, `id_trabalho`, `created_at`, `updated_at`) VALUES
	(15, 'Campus universitário Camama', 58, 66, 77, 69, 4, '2022-08-05 14:00:00', '2022-07-22 13:00:33');
...
-- Dumping data for table sis_tfc.notificacao: ~43 rows (approximately)
/*!40000 ALTER TABLE `notificacao` DISABLE KEYS */;
INSERT INTO `notificacao` (`id`, `mensagem`, `estado`, `id_pessoa`, `created_at`, `updated_at`) VALUES
	(77, 'O Estudante convidado aceitou trabalhar nesta proposta.', 0, 113, '2022-07-22 12:53:49', '2022-07-22 12:53:49'),
	(78, 'A proposta ou sugestão adicionada foi aprovada com sucesso pelo conselho científico. Um novo trabalho foi criado de acordo a sugestão proposta.', 0, 113, '2022-07-22 12:54:25', '2022-07-22 12:54:25'),
	(79, 'A proposta ou sugestão adicionada foi aprovada com sucesso pelo conselho científico. Um novo trabalho foi criado de acordo a sugestão proposta.', 0, 93, '2022-07-22 12:54:25', '2022-07-22 12:54:25'),
	(80, 'Foi publicado o edital contendo a data para a prova pública e a respectiva bancada examinadora. Navegue até ao seu trabalho e abra a aba Edital para ver mais detalhes.', 0, 113, '2022-07-22 13:00:33', '2022-07-22 13:00:33'),
	(81, 'Foi publicado o edital contendo a data para a prova pública e a respectiva bancada examinadora. Navegue até ao seu trabalho e abra a aba Edital para ver mais detalhes.', 0, 93, '2022-07-22 13:00:33', '2022-07-22 13:00:33');
...
-- Dumping data for table sis_tfc.permissions: ~24 rows (approximately)
...
INSERT INTO `permissions` (`id`, `nome`, `desc`, `tipo`, `created_at`, `updated_at`) VALUES
	...
	(24, 'apagar_global_tutor', 'Apagar qualquer coisa por orientador', 2, NULL, NULL);
...
-- Dumping data for table sis_tfc.permission_role: ~35 rows (approximately)
...
INSERT INTO `pessoa` (`id`, `nome`, `data_nascimento`, `telefone`, `bi`, `genero`, `created_at`, `updated_at`) VALUES
	...
	(113, 'Wawingi Sebastiao António', '1990-12-25', 915986452, '003246621LA030', 1, NULL, NULL);
...
-- Dumping data for table sis_tfc.predefesa: ~1 rows (approximately)
...
INSERT INTO `predefesa` (`id`, `avaliacao`, `tipo`, `nota`, `id_trabalho`, `created_at`, `updated_at`) VALUES
	(8, 1, 2, 'Foi realizada a prédefesa, analisou-se o relatório conforme a metodologia escolhida.', 4, '2022-07-20 00:00:00', '2022-07-22 13:00:14');
...
-- Dumping data for table sis_tfc.predefinidoavaliacao_item: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `prova_publica` (
  ...
  `id_trabalho` int(10) unsigned NOT NULL,
  `id_nota_informativa` bigint(20) unsigned NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_notainf_provap` (`id_nota_informativa`),
  CONSTRAINT `fk_notainf_provap` FOREIGN KEY (`id_nota_informativa`) REFERENCES `nota_informativa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table sis_tfc.prova_publica: ~0 rows (approximately)
...
INSERT INTO `prova_publica` (`id`, `nota`, `anotacao`, `id_trabalho`, `id_nota_informativa`, `created_at`, `updated_at`) VALUES
	(28, 19, NULL, 4, 15, '2022-08-05 14:00:00', '2022-07-22 13:01:55');
...
-- Dumping data for table sis_tfc.sugestao: ~0 rows (approximately)
...
INSERT INTO `sugestao` (`id`, `tema`, `descricao`, `proveniencia`, `estado`, `visibilidade`, `id_area`, `id_docente`, `avaliacao`, `created_at`, `updated_at`) VALUES
	(6, 'KULONGA - GESTãO DE TFC\'S', 'KULONGA - Gestão de TFC\'s113.pdf', 2, 3, 1, 6, 69, 1, '2022-07-22 00:00:00', '2022-07-22 00:00:00');
...
-- Dumping data for table sis_tfc.sugestao_departamento: ~0 rows (approximately)
...
-- Dumping data for table sis_tfc.trabalho: ~1 rows (approximately)
...
INSERT INTO `trabalho` (`id`, `tema`, `descricao`, `recomendacao`, `proveniencia`, `estado`, `id_area`, `id_docente`, `created_at`, `updated_at`) VALUES
	(4, 'KULONGA - GESTãO DE TFC\'S', 'Relatorio_KULONGA - GESTãO DE TFC\'S_4.pdf', NULL, 2, 2, 6, 69, '2022-07-22 00:00:00', '2022-07-22 12:57:58');
...
-- Dumping data for table sis_tfc.trabalho_departamento: ~2 rows (approximately)
...
INSERT INTO `users` (`id`, `email`, `email_verified_at`, `password`, `estado`, `tipo`, `qtd_vezes`, `remember_token`, `created_at`, `updated_at`, `id_pessoa`) VALUES
	(1, 'wsa@gmail.com', '2019-09-24 04:00:00', '$2y$10$XpNQefi7MxXb4v.blp.f7.Tc5xP9CGoo5hEaiLEfLoSWYkCEj48BK', 1, 1, 1, '2xTFezqqzX4NbjzCJ5UfojmkrBuIdvTC8iQ0NkrYq6ZQs0MYPHQRUDmkarZw', '2019-09-24 04:00:00', '2019-09-24 04:00:00', 1),
	...
	(33, 'mateuspadoca@hotmail.com', '2019-09-24 04:00:00', '$2y$10$ORbb2H5obkVKJZcCeSY28eSPEEtKeLbxVdpCvHMvcXWtghYaal2SK', 1, 2, 1, 'EsiazUPfqoBKUPmsg6IaAqDZEUwKB3KAxcu8498UMbatQbi5MsyL8pTsdR2O', '2019-09-24 04:00:00', '2019-12-20 03:00:00', 58),
	...
	(37, 'dalton.cabeia@gmail.com', NULL, '$2y$10$FcL.Iu6C.2RqjaAANm0CLuDY.4NDCOdkCYa02VgDAbw4al7DMpQmO', 1, 3, 1, 'JllWdKDoEd5JBqZlcYfvXKJzvqD0x1cQmEfFuE4whHIFuvjf6AlgdZoaiUer', NULL, NULL, 62),
	...
	(42, 'vicente@gmail.com', NULL, '$2y$10$EubNMRl6lUQlSbvPTxOrpuhdvlslb3pr2Dl4HgeydkD9Um.1G7Vhq', 1, 2, 1, 'ludRUpU8c2mxvd55zI0qijAI6SpNsGRo14vQDN785ieA3CE8iQwxtfCjJ8NF', NULL, NULL, 69),
	...
	(82, 'wawingi.antonio@kixicredito.com', NULL, '$2y$10$/Xxoftu2VW9u6CJXUn44cOTwrnsOag/3X.iEv.ar22eTgU6kr81xu', 1, 3, 1, NULL, NULL, NULL, 113);
